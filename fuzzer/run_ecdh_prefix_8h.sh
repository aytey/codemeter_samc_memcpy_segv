#!/bin/bash
# Launch an 8-hour ECDH prefix/dispatcher fuzz campaign over local veth farms.
#
...
#   LOG_DIR=/home/avj/clones/ax_fuzz/output/veth_prefix_8h_logs
...
LOG_DIR="${LOG_DIR:-/home/avj/clones/ax_fuzz/output/veth_prefix_8h_logs}"
